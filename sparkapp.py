...
if __name__ == '__main__':
    ...
    lr_model.write().overwrite().save("s3a://models/linear_regression")
    rf_model.write().overwrite().save("s3a://models/random_forest")
    gbt_model.write().overwrite().save("s3a://models/gradient_boosted_tree")
